    ...
    <div className="w-full py-20 relative bg-navy-dark overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16 flex flex-col gap-3">
          ...
          <p className="font-sans text-text-body max-w-xl mx-auto text-sm sm:text-base leading-relaxed">
          ...
          {reasons.map((reason, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`glass p-6 rounded-xl border border-card-border hover:border-gold-soft/30 transition-all duration-200 group flex flex-col gap-4 hover:translate-y-[-2px]`}
              >
                <div className="w-10 h-10 rounded-lg bg-navy-medium flex items-center justify-center border border-card-border">
