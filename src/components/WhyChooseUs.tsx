          ...
          {reasons.map((reason, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`glass p-5 rounded-2xl border ${reason.border} hover:border-gold-accent/30 transition-all duration-300 group flex flex-col gap-3.5 hover:translate-y-[-4px]`}
              >
                <div className="w-11 h-11 rounded-xl bg-white/5 flex items-center justify-center border border-white/5 group-hover:border-gold-accent/20 transition-colors">
                  <Icon className={`w-5.5 h-5.5 ${reason.color} group-hover:scale-110 transition-transform`} />
                </div>
